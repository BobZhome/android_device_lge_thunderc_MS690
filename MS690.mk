...
DEVICE_PACKAGE_OVERLAYS += device/lge/MS690/overlay
...
PRODUCT_COPY_FILES += \
    ...
    vendor/lge/thunderc/proprietary/$(SUB_MODEL)/bootimages/mpcs_power_on_01.rle:root/bootimages/mpcs_power_on_01.rle \
    vendor/lge/thunderc/proprietary/$(SUB_MODEL)/bootimages/mpcs_power_on_02.rle:root/bootimages/mpcs_power_on_02.rle \
    vendor/lge/thunderc/proprietary/$(SUB_MODEL)/bootimages/mpcs_power_on_03.rle:root/bootimages/mpcs_power_on_03.rle \
    vendor/lge/thunderc/proprietary/$(SUB_MODEL)/bootimages/mpcs_power_on_04.rle:root/bootimages/mpcs_power_on_04.rle \
    vendor/lge/thunderc/proprietary/$(SUB_MODEL)/bootimages/mpcs_power_on_05.rle:root/bootimages/mpcs_power_on_05.rle \
    vendor/lge/thunderc/proprietary/$(SUB_MODEL)/bootimages/mpcs_power_on_06.rle:root/bootimages/mpcs_power_on_06.rle \
    vendor/lge/thunderc/proprietary/$(SUB_MODEL)/bootimages/mpcs_power_on_07.rle:root/bootimages/mpcs_power_on_07.rle \
    vendor/lge/thunderc/proprietary/$(SUB_MODEL)/bootimages/mpcs_power_on_08.rle:root/bootimages/mpcs_power_on_08.rle \
    vendor/lge/thunderc/proprietary/$(SUB_MODEL)/bootimages/mpcs_power_on_09.rle:root/bootimages/mpcs_power_on_09.rle \
    vendor/lge/thunderc/proprietary/$(SUB_MODEL)/bootimages/mpcs_power_on_10.rle:root/bootimages/mpcs_power_on_10.rle \
    vendor/lge/thunderc/proprietary/$(SUB_MODEL)/bootimages/mpcs_power_on_11.rle:root/bootimages/mpcs_power_on_11.rle \
    vendor/lge/thunderc/proprietary/$(SUB_MODEL)/bootimages/mpcs_power_on_12.rle:root/bootimages/mpcs_power_on_12.rle \
    vendor/lge/thunderc/proprietary/$(SUB_MODEL)/bootimages/mpcs_power_on_13.rle:root/bootimages/mpcs_power_on_13.rle \
    vendor/lge/thunderc/proprietary/$(SUB_MODEL)/bootimages/mpcs_power_on_14.rle:root/bootimages/mpcs_power_on_14.rle \
